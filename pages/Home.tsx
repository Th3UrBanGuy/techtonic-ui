    ...
    <>
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden bg-white dark:bg-[#050505] transition-colors duration-500">
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            <Link to="/wings" className="px-8 py-4 bg-slate-900 text-white dark:bg-white dark:text-black font-bold rounded hover:bg-slate-800 dark:hover:bg-gray-200 transition-all flex items-center gap-2 tracking-wide shadow-xl shadow-slate-300/50 dark:shadow-[0_0_20px_rgba(255,255,255,0.3)]">
              EXPLORE ECOSYSTEM <ArrowRight size={18} />
            </Link>
            <Link to="/innovation" className="px-8 py-4 border border-slate-300 text-slate-900 dark:border-white/20 dark:text-white font-medium rounded hover:bg-slate-100 dark:hover:bg-white/10 transition-all backdrop-blur-md">
              R&D LAB ACCESS
            </Link>
          </motion.div>
        </div>
